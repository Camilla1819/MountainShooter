...
from code.Const import C_WHITE, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, SPAWN_TIMET, C_CYAN, C_ORANGE
...
class Level:
    def __init__(self, window, name, game_mode) -> None:
        self.timeout = 20000
        self.window = window
        self.name = name
        ...
        # inicia o timer em qualquer modo de jogo
        pygame.time.set_timer(EVENT_ENEMY, SPAWN_TIMET)
